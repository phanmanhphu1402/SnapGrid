...
import com.jackphan.snapgrid.SettingActivity;
import com.jackphan.snapgrid.UserConfigActivity;
...
public class UserInformationFragment extends Fragment {
    TextView txtUserEmail, txtFollow, flclick, txtUsername, txtCLFollower, txtNumFollower;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Button btnConfigInfor = rootview.findViewById(R.id.btnConfigInfor);
        txtFollow = rootview.findViewById(R.id.txtFollowing);
        txtNumFollower = rootview.findViewById(R.id.txtPeopleFollower);
        ...
        txtCLFollower = rootview.findViewById(R.id.tvfollower);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    if(userFollowings==null){
                        ...
                        txtFollow.setText(String.valueOf(userFollowings.size()));
                    }
                    Map<String, Object> userFollowers = (Map<String, Object>) dataSnapshot.child("followers").getValue();
                    if(userFollowers==null){
                        txtNumFollower.setText("0");
                    }else{
                        txtNumFollower.setText(String.valueOf(userFollowers.size()));
                    }
                    ...
                    try{
                        ...
                        if(userImageUrl.isEmpty()){
                            Drawable drawable = ResourcesCompat.getDrawable(getResources(), R.drawable.user_default, null);
...
//                        int idPost = Integer.parseInt(snapshot.child("idPost").getValue().toString());
        ...
        txtCLFollower.setOnClickListener(view -> {
            FragmentTransaction transaction = fragmentManager.beginTransaction();
        ...
        showPostsSaved.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                postsSavedDialogRecyclerView.setOnClickListener(view1 -> postsSavedDialog.cancel());
